...
import SafeStay.dal.MostUnsafeHour;
import SafeStay.dal.OffenseDao;
import SafeStay.dal.PercentageRecommendLocation;
...
public class Inserter {
	...
	public static void main(String[] args) throws SQLException, ParseException {
		...
		try {
			...
			System.out.println(mostOffense.getOffenseCodeForLocation("(42.23241330, -71.12971531)"));
			...
			// Test Unsafe Hour
			System.out.println("The most unsafe hour: \n");
			MostUnsafeHour uh = MostUnsafeHour.getInstance();
			UnsafeHour u = uh.getMostUnsafeHour("(42.23241330, -71.12971531)");
			System.out.format("h:%s l:%s \n", u.getHour(), u.getLocation());

			// Test Percentage
			PercentageRecommendLocation k1 = PercentageRecommendLocation.getInstance();
			System.out.println("The percentage of people who recommend this location is:"
					+ k1.getPercentageRecommendLocation("(42.23241330, -71.12971531)"));
